...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item linkSize active" aria-current="page"> <i class="fa fa-arrow-right" aria-hidden="true"></i> Change Password</li>
  </ol>
</nav>
</div>
<hr>
	...
	<sf:form method="post"
		...
		<div class="card">
			<h5 class="card-header"
				style="background-color: #00061df7; color: white;">Change Password</h5>
			<div class="card-body">
