...
//Logger is used to create and manage log messages in the application.
//UserDAOImpl.class.getName() retrieves the fully qualified class name of the UserDAOImpl class.	
	@Autowired
